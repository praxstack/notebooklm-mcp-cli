...
class ServiceError(Exception):
    ...
    def __init__(self, message: str, user_message: str | None = None, hint: str | None = None, debug_code: str | None = None):
...
class NotFoundError(ServiceError):
    ...
    def __init__(self, message: str, user_message: str | None = None, hint: str | None = None, resource_type: str = "Resource", debug_code: str | None = None):
        if hint is None:
